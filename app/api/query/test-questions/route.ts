    ...
    return NextResponse.json(
      {
        error: isMissingTable
          ? "Table query_test_questions does not exist yet. Apply supabase/migrations/00000000000006_query_test_questions.sql in the Supabase Dashboard SQL Editor, then click 'Load questions'."
          : error.message,
        code,
        questions: [],
        total: 0,

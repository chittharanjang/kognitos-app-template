    ...
    return NextResponse.json(
      {
        error: isMissingTable
          ? "Table query_test_questions does not exist in Supabase. Apply migration 00000000000006_query_test_questions.sql via the Supabase Dashboard SQL Editor, then click 'Load questions' again."
